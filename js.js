...
$( window ).load(function() {
		...
		'2107-08-24': {
			...
			body: 'Programinfo mellan 8.00 och 10.00, därefter introduktion till Industriell ekonomi och endimensionell analys. Programmet bjuder på lunch och på eftermiddagen är det Case. På kvällen är det dags för den första sittningen.<br><br>Klädkod sittning: Bruten kavaj<br><br>";Sittning betyder middag med fest<br>Du som ny är vår hedersgäst<br>Ett första nationsbesök söderöver<br>Vi ska lära dig allt du behöver";',
		...
		var days = {
			'Vecka 0': {
				...
				'2107-08-21': {
					title: 'Upprop, rundvandring och phaddermys',
				...
				'2107-08-22': {
					...
					body: 'Dagen börjar med inspiration från Framtidens ingenjörer klockan 08:00 och sedan blir det lunch på Västgöta nation, phaddrarna ser till att ni hittar rätt. Eftermiddagen fortsätter med Framtidens ingenjörer och klockan 16:15 blir det Ouvvepåtagning då ni för första gången får bära den vinröda färgen med stolthet.<br><br>"Det kan ibland vara svårt att förstå<br>Men Lund erbjuder mer än LTH<br>Med ouverall som ny allsmäktig stass<br>Bjuder Nöje och Sport på en kväll av högsta klass"',
					map: '55.709428,13.209777',
				},
				'2107-08-23': {
					title: 'Intro i kurserna, case och hur-man-går-på-sittning-sittning',
				...
				'2107-08-25': {
					title: 'Indek, inspiration från AlumnI och tur till Paradiset',
					body: 'Dagen börjar klockan 09:00 med information om hur du läser matematik på LTH som sedan följs av en övning. Efter lunch blir det en inspirationsföreläsning med Alumni och vid 15 åker ni till Paradiset.<br><br>"En resa hör till ett äventyr<br>Det är okänt vart du kosan styr<br>De enda som vet är Styrelsen<br>Det dröjer till lördag innan du kommer hem"',
					dresscode: 'O&ouml;mma kläder',
				},
				'2107-08-26': {
					title: 'Hemkomst, stadsvandring och ED-dischot',
					body: 'Hemkomst till Lund under dagen direkt följt av start på den legendariska poängjakten genom hela Lund. Kvällen avslutas med utomhusrejv som Elektro- och Datasektionen annordnar.<br><br>"Det är dags att visa att din phaddergrupp är den bästa<br>Samla poäng är uppdraget nästa<br>På kvällen väntar fest med hela TLTH<br>Fler färger än vinröd på ouvven kan man få<br>Offra en bit av ditt ena byxben<br>Du kan få en vän från en ny sektion sen"',
					dresscode: 'Ouvve och temakl&auml;dsel',
				},
				'2107-08-27': {
					title: 'Frukost, high five och Nolles&ouml;ndag',
					body: 'Efter en lång lördag blir det frukost med phaddergrupperna och en söndag med aktiviteter tillsammans med Maskinsektionen.<br><br>"Phaddrarna står för din frukostkonsumtion<br>Nollesöndagen är en långtgående tradition<br>Soffor från hela M-huset dras ut<br>Efter detta är första nollningsveckan slut"',
					dresscode: 'Ouvve och temakl&auml;dsel',
			...
			'Vecka 1': {
				...
				'2107-08-28': {
					title: 'Indek, Endim, motivation fr&aring;n SVL och Dagen-D',
					body: 'Dagen börjar med Endim i E:A klockan 10:00 och sedan Indek i MA:6 vid 15:00. Vid 17:00 fortsätter dagen med information från sektionen i MA:6.</br></br>”Phøset har något som är mycket viktigt för oss </br>Vi hoppas att du vill vara med på det förstås </br>Ett brandtal är att förvänta sig</br>Om varför Phøset kommer att behöva just dig”',
					kl: '10:00',
					map:'55.711164,13.210562',
				},
				'2107-08-29': {
					title: 'Ouvvetisdag, Endim, K&aring;rkamp, Indek och I <3 M',
					body: 'Tisdag och därmed Ouvve, det gäller att visa vilken sektion du tillhör och du får chans att bära vinrött med stolthet. Endim i E:A klockan 10:00 och på lunchen är det dags för den första kårkampen, vilken I-sektionen givetvis skall vinna. Det kommer finnas möjlighet att köpa lunch för en billig peng och vid 15:00 är det Indek i MA:6. På kvällen är det traditionsenligt sittning med vår kära systersektion, Maskinsektionen.<br><br>"Vi har grannar i huset som läser M<br>Här har du chansen att lära känna dem<br>Tjejer och killar på varsitt håll får vara<br>Återförenas när man med sittningarna är klara"',
					dresscode: 'Ouvve under dagen och kostym/cocktailkl&auml;nning till kv&auml;llen',
					map: '55.711164, 13.210562'
				},
				'2107-08-30': {
					title: 'Indek, Draggning, Partybr&auml;nnboll och After EIght',
					body: 'Indek klockan 08:00 och vid 17:00 är det dags för Draggning. Vid 19:00 drar partybrännbollen igång, senare på kvällen träffar vi A-sektionen för lite gött häng. </br></br>Draggning</br></br>“Här finns en chans att ge I-sektionen stor ära</br>Kiosken kan vår färg få bära</br>Det handlar om att bada och hitta rätt</br>Vi måste hjälpas åt på alla sätt”</br></br>Partybrännboll</br></br>“Partybrännboll är en sport med historia så lång </br>Nu får du lära dig hur det går till en gång</br>Bad i sjø och häng rätt fett</br>Att hinna med mer på en dag är inte lätt”</br>',
					dresscode: 'Ouvve, badkl&auml;der och snabba skor',
					map:'55.710316,13.208259',
				},
				'2107-08-31': {
					title: 'Indek, Endim och Studiekv&auml;ll',
					body: 'Föreläsning i Indek i V:C klockan 10:00 och sedan föreläsning i Endim i E:A klockan 13:00. Kvällen erbjuder en tid ägnad åt studier tillsammans med SRI, vilken börjar vid 17:00.<br><br>"Studier kan vara svårt utan mammas tjat<br>Här finns lärare och kvällsmat"',
				...
				'2107-09-02': {
					...
					body: 'Klockan 10:00 är det dags för en dansk frukost för att se till att vara ordentligt laddad inför en lång dag i Helsingborg. Bussarna avgår vid 14:00.<br><br>"I Helsingborg det ingenjörer också är<br>Vi tar oss med buss och hälsar på där<br>Farkost har varje sektion byggt varsin<br>Ta dig längst över sundet och vinn!"',
					dresscode: 'Ouvve',
			...
			'Vecka 2': {
				...
				'2107-09-04': {
					...
					body: '08:00 börjar föreläsning i Indek i MA:6 och därefter föreläsning i Endim i E:A. På lunchen har du möjlighet att röra på dig lite och lära dig de andra sektionernas nolledanser. På kvällen anordnas det en studiekväll med mat.',
				},
				'2107-09-05': {
				...
				'2107-09-06': {
					...
					body: 'Föreläsning klockan 15:00 i MA:6 och sedan är det dags för en tradition som härstammar från de gamla grekerna.<br><br>"För din klädsel får du ett lakan vika<br>Vet du inte hur brukar Google inte svika<br>Skriv how to fold a toga i sökfältet<br>Så leker vi grekiska gudar i partytältet"',
					dresscode: 'Toga',
				},
				'2107-09-07': {
				...
				'Vecka 3': {
					...
					'2107-09-11': {
						title: 'Endim, Indek och Den Olympiska Kampen',
					...
					'2107-09-15': {
						...
						body: 'Dagen inleds med Endim kl 08:00 i E:A och kl. 17:00 är det dags för nollningens finalfest - Nollegasquen!</br></br>"Det här blir nollningens stora fest</br>Självklart kommer den att bli allra bäst</br>en trerättersmiddag ska göra oss mätta</br>sen ska du få gå från nolla till etta</br>Glada, snälla, helt underbara</br>Det tror vi varje etta kommer att vara"',
					...
					'Vecka 4': {
						...
						'2107-09-23': {
							title: 'Skidfesten',
							body: '<br><br>"Understället på trots att det är september<br>Bränna, fartdräkt, det är ikväll det händer<br>Nollningen är ännu inte riktigt förbi<br>När Lophtet förvandlas till afterski"',
							dresscode: 'After ski',
					...
					'Vecka 5': {
						...
						'2107-09-28': {
							title: 'Sensation red',
							body: 'Fet fest som anordnas av Maskinsektionen.</br>Mer info kommer.',
							dresscore: 'rött',
						},
						'2107-10-01': {
							title: 'Storslaget',
							body: 'Fest som anordnas av TLTH.</br>Mer info kommer.',
							dresscode: 'Ouvve',
                            map: '55.712472,13.209341',
						}
		};
			...
			if (date.indexOf("Vecka") !== -1) {
				...
				daysHTML += '<li class="dayli '+
					...
					daysHTML += '<div class="slider invis">';
						...
						if(dday.map){
							daysHTML += '<div class="map-container"><a href="https://www.google.com/maps/?q='+dday.map+'"><img class="map" src="http://maps.google.com/maps/api/staticmap?center='+dday.map+'&zoom=16&size=560x200&sensor=false&markers='+dday.map+'&key=AIzaSyBoM1dFFfBz4ToHgSm-XdxdDYfDnGXav-o" width="640" height="200"/></a></div>'
						}
					daysHTML += '</div>';
				daysHTML += '</li>';
			}
